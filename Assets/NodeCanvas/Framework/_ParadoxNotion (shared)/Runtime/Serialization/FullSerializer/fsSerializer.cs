...
*/
        ...
        private fsResult RemoveDefaultValues(Type storageType, object instance, ref fsData data){
            ...
            //exclude actual dictionaries from getting cleaned up, as well as if there is a direct converter
            if (_availableDirectConverters.ContainsKey(type) || typeof(System.Collections.IDictionary).IsAssignableFrom(storageType)){
                return fsResult.Success;
            }
